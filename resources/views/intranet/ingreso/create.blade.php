                        ...
                        <div class="row center">
                            ...
                            <div class="col-sm-4">
                                <div class="form-group">
                                    ...
                                    <select class="caracteristica form-control" name="id_catalogo" id="caracteristica" required>
                                        <option value="" selected="selected" disabled="true"> No ha seleccionado un servicio </option>
                                    </select>
                                </div>
                            </div>
                        ...
                        <div class="row center">
                            <div class="col-sm-2">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="cantidad_muestra" id="stock" class="form-control"  placeholder="En gramos"autocomplete="off">
                                </div>
                            </div>                              
                            <div class="col-sm-2">
                                <div class="form-group">
                                    <label class="control-label">Costo del Analisis: </label><br/>
                                    <input type="text" name="monto" id="costo_analisis" class="form-control" placeholder="S/." id="precio" autocomplete="off">
                                </div>
                            </div>
...
$(document).ready(function () {   
    ...
    //Cargar combo de subtipos
        $("#servicio").change(function(){
            ...
            $.ajax({
                url: "{{ route('intranet.ingreso.subtipos') }}?id=" + $(this).val(),
                method: 'GET',
        ...
        $("#analisis").change(function(){
            console.log($(this).val());
            $.ajax({
                url: "{{ route('intranet.ingreso.subtiposca') }}?id=" + $(this).val(),
                method: 'GET',
